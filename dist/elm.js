...
var _user$project$Type$Game = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {title: a, windowSize: b, player: c, stage: d, direction: e, isJump: f, stageLeft: g, keyPressed: h, keyReleased: i};
	});
...
var _user$project$Main$update = F2(
	function (msg, game) {
		...
		switch (_p0.ctor) {
			...
			case 'KeyPressed':
				return A2(_user$project$Logic$keyPressedUpdate, game, _p0._0);
			case 'KeyReleased':
				return A2(_user$project$Logic$keyReleasedUpdate, game, _p0._0);
			default:
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$Type$game, _1: _elm_lang$core$Platform_Cmd$none},
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Type.Msg":{"args":[],"tags":{"Tick":["Time.Time"],"KeyPressed":["Type.Key"],"KeyReleased":["Type.Key"],"NoOp":[]}},"Type.Key":{"args":[],"tags":{"LeftKey":[],"RightKey":[],"UpKey":[],"DownKey":[],"NoKey":[]}}},"aliases":{"Time.Time":{"args":[],"type":"Float"}},"message":"Type.Msg"},"versions":{"elm":"0.18.0"}});
}
